 ...
 */
function calculateInitialTileSize(p) {
 ...
 */
function calculateGridBounds(p, tileSize) {
...
function calculatePadSize(p) {
    ...
    const padBox = (n) => 3 * n + 26; // 3*pad + gaps(12) + padding(12) + border(2)
 ...
 */
function calculateStatusSize(p, padSizePct) {
    const { isTiny, isPhone, isTablet } = p;
...
export function computeFirstRunLayout(p) {
