...
import { handleBattleItemUse, handleBattleLogClick, handleAdvanceBattleLog, handleActivateSkillOrMagic, handleEnemyStrike, handleExpGoldReward, handleStartBrainQuiz, handleStartEncounter, handleQuizResult } from './handlers/battleHandlers';
import { handleDoSaveToSlot, handleDoLoad, handleDoLoadFromSlot, handleDeleteSlot, handleExportSave, handleImportSave } from './handlers/saveHandlers';
import { buyWeapon, buyArmor, buyTool, restAtInn, handleUseItemField, castFieldHeal, handleEquipAccessory } from './handlers/fieldHandlers';
import { handleChangeStage, handleChangeFloor, handleResetGame, handleTryMove } from './handlers/navigationHandlers';
import { handleBrainOnlyResult, handleStartBrainOnlyQuiz } from './handlers/brainOnlyHandlers';
import { handleConfirmDialog, handleVibration } from './handlers/uiHandlers';
